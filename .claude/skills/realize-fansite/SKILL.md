...
11. **公演情报正文用统一字段模板**(站长要求格式不许不一),按序以「;」分隔,无则省略:
    `出席:成员·间隔号;开场 xx:xx / 开演 xx:xx;特典:…;(注意:…。)`
    标题格式「M/D 场地/活动名,亮点!」;演出预告 until 设演出当天。
    不写的东西:票价/票务(铁律)、主办方、地点(排期与 NEXT LIVE 已含)、
    合影券/抽奖等活动细节(指路原帖即可);特典只写线上切&电切等物贩上架信息。
    里程碑/物贩等其他分类用叙述句,不套此模板。
    演出的 note(备注)由站长决定,AI 不自行添加(活动名等留在情报里即可)。
12. **阿鱼默认缺席**(站长 2026-09-08 定):阿鱼此后不再随团演出,新录任何演出一律
    `absent: ["阿鱼"]`,不必再问;情报/PR 里也不用专门提「阿鱼缺席」。
